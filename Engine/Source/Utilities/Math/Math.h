...
namespace Krampus
{
    ...
    public:
        ...
        static inline NO_DISCARD Real RandomRange(const Real& _min, const Real& _max)
        {
        ...
        static inline NO_DISCARD Real RandomRange(const Real& _min, const Real& _max, uint32_t seed)
        {
