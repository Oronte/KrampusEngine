	...
	: Actor(_level)
{
	...
	animation->AddAnimation("Idle", AnimationData(6, FMath::GetRandomNumberInRange(0.2f, 1.5f), SpriteData(IVector2(0, 0), IVector2(500, 775)), true, true, ReadDirection::RD_ROW));
